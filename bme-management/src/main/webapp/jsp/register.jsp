...
<div class="wrap">
    <div class="container">
        <h1 style="color: whitesmoke; margin: 0; text-align: center">Sign up</h1>
        <form>
            <label>
                <select>
            ...
            <label><input type="text" placeholder="ID Number"/></label>
            <label><input type="text" placeholder="College"/></label>
            <label><input type="text" placeholder="Major"/></label>
            <label><input type="password" placeholder="Password" /></label>
            <label><input type="password" placeholder="Confirm Password" /></label>

            <input type="submit" value="Sign up"/>
            <p class="change_link" style="text-align: center">
                <a href="login.html" class="to_login"> Return </a>
            </p>
        </form>
    </div>
    <ul>
